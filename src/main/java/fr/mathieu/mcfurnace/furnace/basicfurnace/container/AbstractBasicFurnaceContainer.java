package fr.mathieu.mcfurnace.furnace.basicfurnace.container;

import fr.mathieu.mcfurnace.furnace.agoldfurnace.AbstractAGoldFurnaceTileEntity;
import fr.mathieu.mcfurnace.furnace.basicfurnace.AbstractBasicFurnaceTileEntity;
import fr.mathieu.mcfurnace.furnace.basicfurnace.slot.BasicFurnaceFuelSlot;
import fr.mathieu.mcfurnace.furnace.basicfurnace.slot.BasicFurnaceResultSlot;
...
public abstract class AbstractBasicFurnaceContainer extends RecipeBookContainer<IInventory> {
    private final IInventory furnaceInventory;
    private final IIntArray field_217064_e;
    protected final World world;
    private final IRecipeType<? extends AbstractCookingRecipe> recipeType;

    protected AbstractBasicFurnaceContainer(ContainerType<?> containerTypeIn, IRecipeType<? extends AbstractCookingRecipe> recipeTypeIn, int id, PlayerInventory playerInventoryIn) {
        this(containerTypeIn, recipeTypeIn, id, playerInventoryIn, new Inventory(3), new IntArray(4));
    }

    protected AbstractBasicFurnaceContainer(ContainerType<?> containerTypeIn, IRecipeType<? extends AbstractCookingRecipe> recipeTypeIn, int id, PlayerInventory playerInventoryIn, IInventory furnaceInventoryIn, IIntArray p_i50104_6_) {
        ...
        this.addSlot(new BasicFurnaceFuelSlot(this, furnaceInventoryIn, 1, 56, 53));

        this.addSlot(new BasicFurnaceResultSlot(playerInventoryIn.player, furnaceInventoryIn, 2, 116, 35));
    ...
    public boolean isFuel(ItemStack p_217058_1_) {
        return AbstractBasicFurnaceTileEntity.isFuel(p_217058_1_);
    }
