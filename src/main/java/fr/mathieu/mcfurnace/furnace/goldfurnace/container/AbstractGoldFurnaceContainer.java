...
import fr.mathieu.mcfurnace.furnace.goldfurnace.AbstractGoldFurnaceTileEntity;
import fr.mathieu.mcfurnace.furnace.goldfurnace.slot.GoldFurnaceFuelSlot;
import fr.mathieu.mcfurnace.furnace.goldfurnace.slot.GoldFurnaceResultSlot;
...
public abstract class AbstractGoldFurnaceContainer extends RecipeBookContainer<IInventory> {
    private final IInventory furnaceInventory;
    private final IIntArray field_217064_e;
    protected final World world;
    private final IRecipeType<? extends AbstractCookingRecipe> recipeType;

    protected AbstractGoldFurnaceContainer(ContainerType<?> containerTypeIn, IRecipeType<? extends AbstractCookingRecipe> recipeTypeIn, int id, PlayerInventory playerInventoryIn) {
        this(containerTypeIn, recipeTypeIn, id, playerInventoryIn, new Inventory(3), new IntArray(4));
    }

    protected AbstractGoldFurnaceContainer(ContainerType<?> containerTypeIn, IRecipeType<? extends AbstractCookingRecipe> recipeTypeIn, int id, PlayerInventory playerInventoryIn, IInventory furnaceInventoryIn, IIntArray p_i50104_6_) {
        ...
        this.addSlot(new GoldFurnaceFuelSlot(this, furnaceInventoryIn, 1, 56, 53));

        this.addSlot(new GoldFurnaceResultSlot(playerInventoryIn.player, furnaceInventoryIn, 2, 116, 35));
    ...
    public boolean isFuel(ItemStack p_217058_1_) {
        return AbstractGoldFurnaceTileEntity.isFuel(p_217058_1_);
    }
