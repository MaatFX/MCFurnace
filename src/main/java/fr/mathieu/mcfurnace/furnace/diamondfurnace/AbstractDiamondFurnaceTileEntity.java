...
public abstract class AbstractDiamondFurnaceTileEntity extends LockableTileEntity implements ISidedInventory, IRecipeHolder, IRecipeHelperPopulator, ITickableTileEntity {
    ...
    private static final int COOK_SPEED = 6;
    private static final int ADDITIONAL_RECIPE_OUTPUT = 4;
    ...
    protected final IIntArray furnaceData = new IIntArray() {
        public int get(int index) {
            switch(index) {
                case 0:
                    return AbstractDiamondFurnaceTileEntity.this.burnTime;
                case 1:
                    return AbstractDiamondFurnaceTileEntity.this.recipesUsed;
                case 2:
                    return AbstractDiamondFurnaceTileEntity.this.cookTime;
                case 3:
                    return AbstractDiamondFurnaceTileEntity.this.cookTimeTotal;
                default:
                    return 0;
            }
        }
        ...
        public void set(int index, int value) {
            switch(index) {
                case 0:
                    AbstractDiamondFurnaceTileEntity.this.burnTime = value;
                    break;
                case 1:
                    AbstractDiamondFurnaceTileEntity.this.recipesUsed = value;
                    break;
                case 2:
                    AbstractDiamondFurnaceTileEntity.this.cookTime = value;
                    break;
                case 3:
                    AbstractDiamondFurnaceTileEntity.this.cookTimeTotal = value;
    ...
    protected AbstractDiamondFurnaceTileEntity(TileEntityType<?> tileTypeIn, IRecipeType<? extends AbstractCookingRecipe> recipeTypeIn) {
        super(tileTypeIn);
