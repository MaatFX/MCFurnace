...
public abstract class AbstractAGoldFurnaceTileEntity extends LockableTileEntity implements ISidedInventory, IRecipeHolder, IRecipeHelperPopulator, ITickableTileEntity {
    ...
    private static final int COOK_SPEED = 5;
    ...
    protected final IIntArray furnaceData = new IIntArray() {
        public int get(int index) {
            switch(index) {
                case 0:
                    return AbstractAGoldFurnaceTileEntity.this.burnTime;
                case 1:
                    return AbstractAGoldFurnaceTileEntity.this.recipesUsed;
                case 2:
                    return AbstractAGoldFurnaceTileEntity.this.cookTime;
                case 3:
                    return AbstractAGoldFurnaceTileEntity.this.cookTimeTotal;
                default:
                    return 0;
            }
        }
        ...
        public void set(int index, int value) {
            switch(index) {
                case 0:
                    AbstractAGoldFurnaceTileEntity.this.burnTime = value;
                    break;
                case 1:
                    AbstractAGoldFurnaceTileEntity.this.recipesUsed = value;
                    break;
                case 2:
                    AbstractAGoldFurnaceTileEntity.this.cookTime = value;
                    break;
                case 3:
                    AbstractAGoldFurnaceTileEntity.this.cookTimeTotal = value;
    ...
    protected AbstractAGoldFurnaceTileEntity(TileEntityType<?> tileTypeIn, IRecipeType<? extends AbstractCookingRecipe> recipeTypeIn) {
        super(tileTypeIn);
